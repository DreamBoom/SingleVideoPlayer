...
public final class MeasureHelper {
    ...
    // 视频显示模式
    private int mCurrentAspectRatio = PlayerConstants.AR_ASPECT_FIT_PARENT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentAspectRatio == PlayerConstants.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST || heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case PlayerConstants.AR_16_9_FIT_PARENT:
                        // 16：9
                        ...
                        break;
                    case PlayerConstants.AR_4_3_FIT_PARENT:
                        // 4：3
                        ...
                        break;
                    case PlayerConstants.AR_ASPECT_FIT_PARENT:
                    case PlayerConstants.AR_ASPECT_FILL_PARENT:
                    case PlayerConstants.AR_ASPECT_WRAP_CONTENT:
                    default:
                        // 按视频来源宽高比
