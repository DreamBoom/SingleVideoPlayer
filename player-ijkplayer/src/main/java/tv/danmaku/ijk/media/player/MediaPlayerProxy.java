...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void setOnPreparedListener(OnPreparedListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnPreparedListener(mp ->
    ...
    public void setOnCompletionListener(OnCompletionListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnCompletionListener(mp ->
    ...
    public void setOnBufferingUpdateListener(OnBufferingUpdateListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnBufferingUpdateListener((mp, percent) ->
    ...
    public void setOnSeekCompleteListener(OnSeekCompleteListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnSeekCompleteListener(mp ->
    ...
    public void setOnVideoSizeChangedListener(OnVideoSizeChangedListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnVideoSizeChangedListener((mp, width, height, sar_num, sar_den) ->
    ...
    public void setOnErrorListener(OnErrorListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnErrorListener((mp, what, extra) ->
                    finalListener.onError(MediaPlayerProxy.this, what, extra));
        } else {
    ...
    public void setOnInfoListener(OnInfoListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnInfoListener((mp, what, extra) ->
                    finalListener.onInfo(MediaPlayerProxy.this, what, extra));
        } else {
