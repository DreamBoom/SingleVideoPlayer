...
//        private static Field sField_TN_Handler;
        ...
        SystemToast(Toast toast) {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
                try {
                    ...
                    Field sFieldTN = Toast.class.getDeclaredField("mTN");
                    sFieldTN.setAccessible(true);
                    Object mTN = sFieldTN.get(toast);
                    Field sFieldTNHandler = sFieldTN.getType().getDeclaredField("mHandler");
                    sFieldTNHandler.setAccessible(true);
                    Handler tnHandler = (Handler) sFieldTNHandler.get(mTN);
                    sFieldTNHandler.set(mTN, new SafeHandler(tnHandler));
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private Utils.OnActivityDestroyedListener listener = activity -> cancel();
...
//            }
            ...
            HANDLER.postDelayed(this::cancel,
