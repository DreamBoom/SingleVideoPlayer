...
import com.google.android.exoplayer2.ext.ffmpeg.egl.GLViewRenderer;
...
class FrameRenderer implements GLViewRenderer, IFrameRenderer {
   ...
   */
  private FrameBuffer renderedOutputBuffer;
...
//    float[] colorConversion = kColorConversion709;
    ...
    GLES20.glUniformMatrix3fv(colorMatrixLocation, 1, false, kColorConversion709, 0);
